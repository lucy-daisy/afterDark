...
if setup = false
	...
	for(var p = 0; p < page_number; p++)
		...
		//get the x position for the textbox
			...
			text_x_offset[p] = 35;
			portrait_x_offset[p] = 3.5;
			//character on the right
			if speaker_side[p] == -1 {
				text_x_offset[p] = 3.5;
				portrait_x_offset[p] = 142;
			}
...
if draw_char == text_length[page] && page == page_number - 1
	...
	for (var op = 0; op < option_number; op++)
		...
		draw_sprite_ext(txtb_spr[page], txtb_img, _txtb_x + 12, _txtb_y - _op_space*option_number + _op_space*op, _o_w/txtb_spr_w, (_op_space-1)/txtb_spr_h, 0, c_white, 1)
		...
		//the option text
		draw_text(_txtb_x + 12 + _op_bord, _txtb_y - _op_space*option_number + _op_space*op + 2, option[op]);
		}
